...
const DESCRIPTION =
  ...
  'open-source platform at a three-person startup in Germany. 8 pull requests merged into Google, ' +
  'AWS, NVIDIA and Anthropic repositories. MS Computer Science at UT Dallas.'
